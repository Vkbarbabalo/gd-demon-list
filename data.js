...
const coreUIStructure = `
    ...
    <div id="admin-section" class="content-section">
        ...
        <div class="admin-form" style="border-color: #00d2ff;">
            ...
            <button id="btn-reset" style="background:transparent; color:#ff4757; border:none; margin-top:15px; cursor:pointer; width:100%;">⚠️ Wipe Local Edits</button>
        </div>
    </div>
